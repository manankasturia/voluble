          ...
          <div key={section}>
            ...
            {section === "Product" ? (
              <ul className="flex flex-col gap-3">
                <li key={items[0]}>
                  <Link to="/#features" className="text-white/38 hover:text-white text-sm transition-colors">
                    {items[0]}
                  </Link>
                </li>
                <li key={items[1]}>
                  <Link to="/#use-cases" className="text-white/38 hover:text-white text-sm transition-colors">
                    {items[1]}
                  </Link>
                </li>
                <li key={items[2]}>
                  <Link to="/how-it-works" className="text-white/38 hover:text-white text-sm transition-colors">
                    {items[2]}
                  </Link>
                </li>
                <li key={items[3]}>
                  <Link to="/pricing" className="text-white/38 hover:text-white text-sm transition-colors">
                    {items[3]}
                  </Link>
                </li>
              </ul>

...
const Left = () => {
  return (
    <div className=' h-full w-[60%] flex flex-col justify-center items-center pl-12'>
        ...
        <p className=' pr-20 mt-10 text-xl'>Poised is your AI communication coach, offering
             real-time feedback to help you speak confidently during calls. Get
              personalized suggestions and actionable insights. Your progress is 
              tracked privately, just for you.</p>
